...
func (l *WebhookPostMessageLogic) WebhookPostMessage(w http.ResponseWriter, r *http.Request) {
	...
	//rs, err := l.svcCtx.PowerX.WeCom.API.Server.Notify(r, func(event contract.EventInterface) interface{} {
	rs, err := l.svcCtx.PowerX.SCRM.WeCom.Client.Server.Notify(r, func(event contract.EventInterface) interface{} {
