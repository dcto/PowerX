...
type WeComExternalContact struct {
	...
	WeComExternalContactFollow WeComExternalContactFollow `gorm:"foreignKey:ExternalUserId;references:external_user_id" json:"WeComExternalContactFollow"`
...
func (mdl *WeComExternalContact) TableName() string {
	return model.PowerXSchema + "." + model.TableNameWeComExternalContact
}

func (mdl *WeComExternalContact) GetTableName(needFull bool) string {
	tableName := model.TableNameWeComExternalContact
	if needFull {
...
//	@param db
//	@return contacts
func (mdl *WeComExternalContact) Query(db *gorm.DB) (contacts []*WeComExternalContact) {
...
//	@param db
//	@param contacts
func (mdl *WeComExternalContact) Action(db *gorm.DB, contacts []*WeComExternalContact) {
