...
type WeComExternalContactFollow struct {
	...
	WeComChannels  string `gorm:"comment:Channels;column:wechat_channels" json:"wechat_channels"`
...
func (mdl *WeComExternalContactFollow) TableName() string {
	return model.PowerXSchema + "." + model.TableNameWeComExternalContactFollow
}

func (mdl *WeComExternalContactFollow) GetTableName(needFull bool) string {
	tableName := model.TableNameWeComExternalContactFollow
	if needFull {
...
//	@param db
//	@return follows
func (e WeComExternalContactFollow) Query(db *gorm.DB) (follows []*WeComExternalContactFollow) {
...
//	@param db
//	@param contacts
func (e *WeComExternalContactFollow) Action(db *gorm.DB, contacts []*WeComExternalContactFollow) {
...
//	@return follows
func (e WeComExternalContactFollow) FindFollowByExternalUserId(db *gorm.DB, externalUserId string) (follow *WeComExternalContactFollow) {
