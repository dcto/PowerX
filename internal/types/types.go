...
type ActionWeComGroupQRCodeActiveReply struct {
	Status string `json:"status"`
}
...
type CreateWeComSourceImageReply struct {
...
type GetWeComCustomerReply struct {
	WeComCustomer
}

type GetWeComCustomerRequest struct {
	Id string `path:"id"`
}
...
type ListWeComCustomersReply struct {
...
type ListWeComCustomersRequest struct {
	LikeName     string `form:"likeName,optional"`
...
type ListWeComGroupQRCodeActiveReqeust struct {
...
type ListWeComQRCodeActiveReply struct {
...
type ListWeComResourceImageReply struct {
...
type ListWeComResourceImageRequest struct {
	ResourceType string `json:"resourceType,optional"`
	PageIndex    int    `form:"pageIndex,optional"`
	PageSize     int    `form:"pageSize,optional"`
}

type ListWeComTagGroupPageReply struct {
...
type ListWeComTagGroupPageRequest struct {
	GroupId   string `json:"groupId,optional"`
	GroupName string `json:"groupName,optional"`
	PageIndex int    `form:"pageIndex,optional"`
	PageSize  int    `form:"pageSize,optional"`
...
type ListWeComTagGroupReply struct {
	List []*WeComTagGroup `json:"list"`
}

type ListWeComTagOptionReply struct {
	List interface{} `json:"list"`
}

type ListWeComTagReply struct {
...
type ListWeComTagReqeust struct {
	TagIds    []string `json:"tagIds,optional"`
	GroupIds  []string `json:"groupIds,optional"`
	Name      string   `json:"name,optional"`
...
type PatchWeComCustomerReply struct {
	WeComCustomer
}

type PatchWeComCustomerRequest struct {
	Id          string `path:"id"`
	Name        string `json:"name,optional"`
...
type SyncWeComCustomerReply struct {
	Status string `json:"status"`
}

type SyncWeComOrganizationReply struct {
	Status string `json:"status"`
}
...
type WeComAddMsgTemplateRequest struct {
...
type WeComCustomerGroup struct {
	ChatId     string                          `json:"chatId"`
	Name       string                          `json:"name"`
...
type WeComCustomerGroupAdminList struct {
	UserId string `json:"userId"`
}

type WeComCustomerGroupMemberList struct {
	UserId        string                              `json:"userId"`
	Type          int                                 `json:"type"`
...
type WeComCustomerGroupMemberListInvitor struct {
	UserId string `json:"userId"`
}

type WeComCustomerGroupRequest struct {
...
type WeComCustomersFollowUserWithTags struct {
	GroupName string `json:"groupName"`
...
type WeComCustomersFollowUserWithWeComChannels struct {
	Nickname string `json:"nickname"`
	Source   int    `json:"source"`
}

type WeComCustomersRequest struct {
...
type WeComCustomersWithExternalContactExternalProfile struct {
	ExternalUserId  string                                            `json:"externalUserId"`
	Name            string                                            `json:"name"`
	Position        string                                            `json:"position"`
	Avatar          string                                            `json:"avatar"`
...
type WeComCustomersWithFollowUser struct {
	UserId         string                                    `json:"userId"`
	Remark         string                                    `json:"remark"`
	Description    string                                    `json:"description"`
...
type WeComListCustomersReply struct {
...
type WeComSyncCustomerReply struct {
	Status string `json:"status"`
}
...
type WeComTextOfMessage struct {
